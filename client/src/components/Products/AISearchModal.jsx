...
const AISearchModal = () => {
  ...
  const exampleText = [
    "Find the best electronics for me",
    "Find all fashion products for men",
    "Show me the best refreshing drinks",
    "Find delicious food products",
    "Find fresh fruits for me",
    "Show me the best sweets and desserts",
    "Find the best products for kids",
    "Show me popular books and novels",
    "Find the best sports and fitness products",
  ];
        ...
        <form onSubmit={handleSearch} className="space-y-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-secondary border border-border rounded-lg focus:outline-none focus:ring-2
               focus:ring-primary text-foreground placeholder-muted-foreground"
              required
              autoFocus
            />
          </div>
          ...
          <button
            ...
            className={`w-full py-4 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-lg font-semibold
               hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 ${aiSearching && "animate-pulse"
              }`}
          >
            {aiSearching ? (
              <>
